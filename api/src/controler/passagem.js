...
export async function sendMail() {
  ...
  try {
    const message = await transporter.sendMail({
      ...
      html: "Aqui estão suas passagem. A equipe da YARA espera que voce tenha uma excelente viagem conosco. Qualquer dúvida pode entrar em contato com esse email ou em uma das nossas redes sociais.  <a href='pass.html'>Suas viagens</a>"  
    });
